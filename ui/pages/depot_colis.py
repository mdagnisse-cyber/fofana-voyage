    ...
    def _popup_succes(self, colis: dict):
        ...
        def _pdf(*a):
            try:
                ...
                popup.dismiss()
                ok_pdf, msg_pdf = ouvrir_fichier(chemin)
                self.msg.afficher(msg_pdf, succes=ok_pdf)
            except Exception as e:
